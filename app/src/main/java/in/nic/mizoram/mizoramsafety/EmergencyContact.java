    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnRegisterEmer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Vibrator vibrator = (Vibrator) EmergencyContact.this.getSystemService(Context.VIBRATOR_SERVICE);
               ...
               try
               {
                   ...
                   if (ConnectivityCheck.isConnectedToNetwork(EmergencyContact.this)) {

                       firebaseFirestore.collection("Users").document(fireBaseUser).collection("EmergencyContact").document("1").set(contactModel)   ;
                       Toast.makeText(getApplicationContext(),"Successfully Registered!",Toast.LENGTH_LONG).show();
                       startActivity(new Intent(EmergencyContact.this,MapsActivity.class));
                       finish();
                       ...
                       new AlertDialog.Builder(EmergencyContact.this)
                               ...
                               .setMessage("Please enable Your data connectivity and try again !")
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("YES",new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        EmergencyContact.super.onBackPressed();
                        finish();
