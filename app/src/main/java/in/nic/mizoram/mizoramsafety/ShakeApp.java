...
public class ShakeApp extends Service implements SensorEventListener{
    // Hetah hian lan Private Members
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (mAccel > 11) {
           ...
           // int color = Color.argb(255, rnd.nextInt(256), rnd.nextInt(256), rnd.nextInt(256));
            ...
            startActivity( new Intent(ShakeApp.this,MapsActivity.class));
        }
    }
